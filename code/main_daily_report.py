...
# 1. Extract — the same source Finance and Marketing use.
raw_data = get_raw_sales_data(seed)

# 2. Transform — clean the rows, total them, roll them up by day, then find the
#    busiest day twice: once by revenue, once by units sold.
...
# 3. Load — the day table, a blank line, then three headline lines.
